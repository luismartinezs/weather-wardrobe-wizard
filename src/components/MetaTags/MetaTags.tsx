const MetaTags = (): JSX.Element => {
  return (
    <>
      ...
      <meta
        name="twitter:url"
        content="https://weather-wardrobe-wizard.netlify.app"
      />
      <meta name="twitter:title" content="Weather Wardrobe Wizard" />
      <meta name="twitter:description" content="Weather Wardrobe Wizard" />
      <meta
        name="twitter:image"
        content="https://weather-wardrobe-wizard.netlify.app/icons/android-chrome-192x192.png"
      />
      ...
      <meta
        property="og:image"
        content="https://weather-wardrobe-wizard.netlify.app/icons/apple-touch-icon.png"
      />
    </>
  );
};
